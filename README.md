...
four tools, the rules a change to a token or a rule is held to, and what the weekly maintenance job
does and does not check. [docs/publication-record.md](docs/publication-record.md) records how the
